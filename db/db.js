...
mongoose.connect('mongodb://arpan:qwerty12345@ds043398.mongolab.com:43398/asce');
...
var EventsOppCol = mongoose.model( 'EventsOppColSchema', EventsOppColSchema , 'EventsOppColSchema');
var MainSchema = mongoose.model('MainSchema',MainSchema,'MainSchema');
var Calender = mongoose.model('CalenderSchema',CalenderSchema,'CalenderSchema');
var Members = mongoose.model('MembersSchema',MembersSchema,'MembersSchema');
var Gallery = mongoose.model('GallerySchema',GallerySchema,'GallerySchema');
